...
class Extract():
    def __init__(self, sum_of_file, topnum_byte_feature_dict, count_byte_feature_dict, topnum_op_feature_dict,
    ...
    def __call__(self, file):
        ...
        self.features.append(
            NGram.extract(file, self.sum_of_file, self.topnum_byte_feature_dict, self.count_byte_feature_dict,
                          self.topnum_op_feature_dict, self.count_op_feature_dict, self.N))
